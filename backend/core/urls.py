...
urlpatterns = [
    ...
    path('users/<uuid:pk>/compositions/',
         get_compositions_from_user, name='get_compositions_from_user'),
    path('users/<uuid:pk>/playlists/',
         get_playlists_from_user, name='get_playlists_from_user'),
